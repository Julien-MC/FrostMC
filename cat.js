...
function check() {
document.body
if (document.body.textContent.includes("FrostMC")) {
    var modified = "Are you sure you want to run this code?";
} else {
    var modified = "Are you sure you want to run this code?";
} 
